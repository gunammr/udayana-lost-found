...
@section('title', 'Barang Ditemukan – Udayana Lost & Found')
...
@section('content')
    ...
    <section class="relative overflow-hidden bg-background py-16 lg:py-20">
        ...
        <div class="pointer-events-none absolute bottom-0 right-10 h-64 w-64 rounded-full bg-warning/20 blur-3xl"></div>
        ...
        <div class="relative mx-auto max-w-7xl px-6">
            ...
            <div class="text-center">
                ...
                <p class="mx-auto mt-4 max-w-xl text-base text-body">
                    Daftar barang yang telah ditemukan di lingkungan Universitas Udayana.
                    Kenali barang Anda dan ajukan klaim segera.
                </p>
    ...
    <section class="relative pb-24">
        ...
        <div class="mx-auto max-w-7xl px-6">
            ...
            <p class="mb-6 text-sm text-body">
                Menampilkan
                <span class="font-semibold text-primary-dark">{{ $foundItems->total() }}</span>
                barang ditemukan
                @if($search)
            ...
            @if($foundItems->isEmpty())
                ...
                <div class="flex flex-col items-center justify-center py-24 text-center">
                    ...
                    <h2 class="mt-5 text-lg font-bold text-primary-dark">Tidak Ada Barang Ditemukan</h2>
