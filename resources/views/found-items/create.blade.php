...
@section('title', 'Barang Ditemukan')
...
@section('content')
    ...
    <section class="relative overflow-hidden bg-background py-16 lg:py-20">
        ...
        <div class="absolute bottom-24 left-1/4 h-48 w-48 rounded-full bg-emerald-100/30 blur-3xl"></div>
        ...
        <div class="relative mx-auto max-w-3xl px-6">
            ...
            <div class="rounded-2xl border border-blue-100/70 bg-white/90 p-6 shadow-card backdrop-blur-md sm:p-8 lg:p-10">
                ...
                @if (session('success'))
                    <div class="mt-8 rounded-xl border border-green-200 bg-green-50 px-5 py-4 text-sm font-semibold text-green-800">
                        {{ session('success') }}
                    </div>
                @endif
                ...
                <form
                    ...
                    <div>
                        ...
                        <label for="photo"
                            ...
                            <span x-show="!photoPreview" class="flex h-14 w-14 items-center justify-center rounded-full bg-soft-blue text-primary">
