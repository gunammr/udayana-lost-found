            ...
            <div class="grid gap-8 lg:grid-cols-[45%_1fr] lg:gap-12 xl:gap-16 items-start">
                ...
                <div class="relative">
                    ...
                    <div class="relative overflow-hidden rounded-2xl shadow-card">
                        ...
                        {{-- DITEMUKAN badge overlay --}}
                        <div class="absolute left-4 top-4">
                            <span class="inline-flex items-center gap-1.5 rounded-full bg-emerald-500 px-4 py-1.5 text-sm font-bold uppercase tracking-wide text-white shadow-lg">
