            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @forelse ($items as $item)
                                ...
                                <div class="h-64 w-full relative bg-gray-100">
                                    ...
                                    @else
                                        <div class="w-full h-full flex items-center justify-center text-gray-300">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-16" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                                        </div>
                                    @endif
                                ...
                                <div class="p-8">
                                    ...
                                    <div class="grid grid-cols-2 gap-y-6 gap-x-4 bg-gray-50 p-6 rounded-2xl mb-6">
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <p class="text-sm font-bold text-blue-600 flex items-center gap-1">
                                    ...
                                    <div class="space-y-2 text-xs text-gray-600 border-b pb-6 mb-6">
                                        <div class="grid grid-cols-3">
                                            <span class="text-gray-400">ID Barang:</span>
                                            <span class="col-span-2 font-medium">#{{ $item->id }}</span>
                                        </div>
                                        <div class="grid grid-cols-3">
                                            <span class="text-gray-400">Warna / Ciri:</span>
                                    ...
                                    <div class="space-y-6 relative before:absolute before:left-2 before:top-2 before:bottom-2 before:w-0.5 before:bg-gray-100">
                                        ...
                                        <div class="relative pl-8">
                                            ...
                                            <p class="text-sm font-bold {{ $item->status != 'dicari' ? 'text-gray-800' : 'text-gray-300' }}">Sedang Dicari / Diverifikasi</p>
                                            <p class="text-xs text-gray-400">Petugas dan tim keamanan kampus sedang memantau area sekitar</p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-span-2 text-center py-12 bg-white rounded-2xl border border-gray-100">
                        <p class="text-sm text-gray-400">No reports found.</p>
                    </div>
                @endforelse
            </div> </div> </div> </div>
@endsection