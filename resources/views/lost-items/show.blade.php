        ...
        <div class="relative mx-auto max-w-7xl px-6">
            ...
            <div class="grid gap-8 lg:grid-cols-[45%_1fr] lg:gap-12 xl:gap-16 items-start">
                ...
                <div class="relative">
                    ...
                    <div class="relative overflow-hidden rounded-2xl shadow-card">
                        ...
                        <div class="absolute left-4 top-4">
                            <span class="inline-flex items-center gap-1.5 rounded-full px-4 py-1.5 text-sm font-bold uppercase tracking-wide text-white shadow-lg
                                {{ $lostItem->status === 'selesai' ? 'bg-emerald-500' : ($lostItem->status === 'ditemukan' ? 'bg-blue-500' : ($lostItem->status === 'dicari' ? 'bg-amber-500' : 'bg-red-500')) }}">
                                @if($lostItem->status === 'selesai')
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                                    </svg>
                                @elseif($lostItem->status === 'ditemukan')
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    {{-- CTA Buttons --}}
                    @if(in_array($lostItem->status, ['hilang', 'dicari']))
                    ...
                    <div class="rounded-xl bg-gray-50 border border-gray-100 p-4 text-center">
                        <p class="text-sm font-bold text-gray-500">
                            Laporan Kehilangan ini telah selesai atau barang sudah ditemukan.
                        </p>
                    </div>
                    @endif
