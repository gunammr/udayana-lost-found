    ...
    <section class="relative overflow-hidden bg-background py-16 lg:py-20">
        ...
        <div class="relative mx-auto max-w-3xl px-6">
            ...
            <div class="rounded-2xl border border-blue-100/70 bg-white/90 p-6 shadow-card backdrop-blur-md sm:p-8 lg:p-10">
                ...
                <div class="mx-auto mt-8 grid max-w-sm grid-cols-2 rounded-lg border border-gray-300 bg-white p-1 text-center text-sm font-semibold">
                    <a href="{{ route('lost-items.create') }}"
                        class="rounded-md bg-primary px-4 py-2 text-white shadow-sm">
                        Barang Hilang
                    </a>
                ...
                <form class="mt-8 space-y-5">
                    ...
                    <div>
                        ...
                        <input id="item_name" name="item_name" type="text"
                            ...
                            class="mt-2 w-full border-gray-300 bg-white text-sm text-primary-dark placeholder:text-gray-400 focus:border-primary focus:ring-primary">
                    </div>
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        <div>
                            ...
                            <select id="category" name="category"
                                class="mt-2 w-full border-gray-300 bg-white text-sm text-primary-dark focus:border-primary focus:ring-primary">
                    ...
                    <div>
                        ...
                        <div class="relative mt-2">
                            ...
                            <input id="location" name="location" type="text"
                                ...
                                class="w-full border-gray-300 bg-white pl-10 text-sm text-primary-dark placeholder:text-gray-400 focus:border-primary focus:ring-primary">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="5"
                            ...
                            class="mt-2 w-full resize-none border-gray-300 bg-white text-sm text-primary-dark placeholder:text-gray-400 focus:border-primary focus:ring-primary"></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <label for="photo"
                            ...
                            <span class="flex h-14 w-14 items-center justify-center rounded-full bg-soft-blue text-primary">
                            ...
                            <span class="mt-4 text-sm font-bold text-primary">
                                Klik untuk memilih file atau seret ke area ini
                            </span>
